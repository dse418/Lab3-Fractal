...
// Define RGB_Pixel array and RGB max value
...
// OpenMP parallel for directive with schedule clause
...
int main(int argc, const char **argv) {
    ...
    // Define colors array and set Max_Iterations value
